...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_uri', action='store_true', help='Use the MNIST dataset from the Keras API')
    parser.add_argument('--test_data_dir', type=str, help='URI of the MNIST dataset from the Keras API')
    parser.add_argument('--accuracy_path', type=str, default='outputs', help='Path to the accuracy txt')
    args = parser.parse_args()

    evaluate_model(args.model_path, args.use_uri, args.test_data_dir, args.accuracy_path)
